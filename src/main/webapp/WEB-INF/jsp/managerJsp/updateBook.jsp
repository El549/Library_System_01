            ...
            <div class="container-fluid">
                <form action="${pageContext.request.contextPath}/manager/updateBook_method?bookId=${book.bookId}" method="post">
                    <div class="form-group">
                        <label>封面url</label>
                        <input type="url" class="form-control" placeholder="URL" name="bookCover" value="${book.bookCover}">
                    </div>
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>${book.bookId}</td>
                                ...
                                <td><input class="form-control" placeholder="bookName" name="bookName" value="${book.bookName}"></td>
                                <td><input class="form-control"placeholder="author" name="author" value="${book.author}"></td>
                                <td><input class="form-control"placeholder="press" name="press" value="${book.press}"></td>
                                <td><input class="form-control"placeholder="bookClass" name="bookClass" value="${book.bookClass}"></td>
                                <td><input class="form-control"placeholder="bookStatus" name="bookStatus" value="${book.bookStatus}"></td>
