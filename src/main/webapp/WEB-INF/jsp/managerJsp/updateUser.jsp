                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>${user.userId}</td>
                            <form action="${pageContext.request.contextPath}/manager/updateUser_method?userId=${user.userId}" method="post">
                                <td><input class="form-control" placeholder="userName" name="userName" value="${user.userName}"></td>
                                <td><input class="form-control" placeholder="userPassword" name="userPassword" value="${user.userPassword}"></td>
